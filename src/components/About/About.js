      ...
      <Grid container item xs={12} className="about__content">
        <Grid item xs={12} lg={8} className="about__content__text">
          ...
          <Typography variant="inherit" component="p">
            ...
            the project and deploying it in production I was looking for working in different
            domains and started working in Primesoft IP Solutions Pvt. Ltd. as a Software Engineer.
            I'm currently working in this organization for almost 1 year. During this time period
            I've worked there in a banking project and other projects using various tools and
